...
RegisterServerEvent('esx_policejob:handcuffPasta')
AddEventHandler('esx_policejob:handcuffPasta', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'police' then
		TriggerClientEvent('esx_policejob:handcuffPasta', target)
	else
		TriggerClientEvent('esx_policejob:handcuffPasta', target)
	end
end)

RegisterServerEvent('esx_policejob:handcuffPasta2')
AddEventHandler('esx_policejob:handcuffPasta2', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_policejob:handcuffPasta', target)
end)
